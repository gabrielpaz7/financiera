...
public class Webservice {
    ...
    private static void parseResponse(String response) throws JAXBException {
        ...
        JAXBContext context = JAXBContext.newInstance(ResultadoEstadoCliente.class);
        Unmarshaller um = context.createUnmarshaller();
        ResultadoEstadoCliente resultadoEstadoCliente = (ResultadoEstadoCliente) um.unmarshal(reader);
